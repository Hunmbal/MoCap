...
def get_random_data():
    ...
    return {
        ...
        "l_shoulder": tuple(round(random.random(), 2) for _ in range(9)),
        "l_elbow": tuple(round(random.random(), 2) for _ in range(9)),
        "l_wrist": tuple(round(random.random(), 2) for _ in range(9)),
        "r_shoulder": tuple(round(random.random(), 2) for _ in range(9)),
        "r_elbow": tuple(round(random.random(), 2) for _ in range(9)),
        "r_wrist": tuple(round(random.random(), 2) for _ in range(9)),
        "l_hip": tuple(round(random.random(), 2) for _ in range(9)),
        "l_knee": tuple(round(random.random(), 2) for _ in range(9)),
        "l_ankle": tuple(round(random.random(), 2) for _ in range(9)),
        "r_hip": tuple(round(random.random(), 2) for _ in range(9)),
        "r_knee": tuple(round(random.random(), 2) for _ in range(9)),
        "r_ankle": tuple(round(random.random(), 2) for _ in range(9)),
    }
