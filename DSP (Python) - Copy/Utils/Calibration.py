...
# Calibration.py
CALIBRATION_POSES = {
    'Tpose': {'file': 'Tpose.yml', 'instruction': 'Stand in T-pose (arms horizontal)'},
    'Ipose': {'file': 'Ipose.yml', 'instruction': 'Stand in I-pose (arms vertical)'},
    'Lpose': {'file': 'Lpose.yml', 'instruction': 'Stand in L-pose (arms pointing forward)'}
}
